...
public class Player extends Entity {
	...
	private boolean left, right, jump;//---> store button movement for char
	private int[][] lvlData; //-----> store level for char
	// 21.4 là tọa độ (x,y) hướng thể hiện hitbox của nhân vật
		//  --------------------  x
		//  |       |
		//  |       |  (21)
		//  |       |
